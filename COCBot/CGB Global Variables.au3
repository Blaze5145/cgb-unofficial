...
Global $AttackTHType
;Global $chklighspell
Global $DELightSpell=0 ;DE Zapping MOD
...
Global $THL
Global $deployBSettings ;Method of deploy for specified Town Hall and below found in attack settings
Global $deployTHSettings ;Specified Town Hall level found in attack settings
Global $deployASettings ;Method of deploy for Town Halls above the specified found in attack settings
...
;DE Zapping MOD
Global $SpellMinDarkStorage = 250
...
Global $itxtUpgrMinGold
Global $itxtUpgrMinElixir
Global $iVSDelay
