...
ClashGameBot is distributed in the hope that it will be 4ul,
...
;~ -------------------------------------------------------------
 $tabAttackAdv = GUICtrlCreateTabItem("Attack Adv. ")
	...
	$grpAtkOptions = GUICtrlCreateGroup("Attack Options", $x - 20, $y - 20, 450, 120)
		...
		$y +=22
		$chkLightSpell = GUICtrlCreateCheckbox("Hit Dark Elixir Storage With Lightning Spell, Minimum ", $x, $y, -1, -1)
			GUICtrlSetTip(-1, "Check this if you want to use Lightning Spells to zapping Dark Elixir when bot meet Minimum Dark Elixir.")
			GUICtrlSetOnEvent(-1, "chkLightSpell")
	    $txtMinDarkStorage = GUICtrlCreateInput("250", $x + 270, $y, 30, 21, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
			GUICtrlSetLimit(-1, 4)
			GUICtrlSetState(-1, $GUI_DISABLE)
		$lblSpellDarkStorage = GUICtrlCreateLabel("Dark Elixir", $x + 305, $y + 4, -1, -1)
			GUICtrlSetTip(-1, "Check this if you want to use Lightning Spells to zapping Dark Elixir when bot meet Minimum Dark Elixir.")
		$y +=27
...
Local $x = 30, $y = 160
	...
	Local $x = 30, $y = 380
	$grpPushBulletNotifications = GUICtrlCreateGroup("PushBullet Notifications", $x - 20, $y - 20, 450, 105)
		...
		$txtPushBulletToken = GUICtrlCreateInput("", $x + 150, $y + 2, 260, 21)
			GUICtrlSetState(-1, $GUI_DISABLE)
	    $lblPushMessage = GUICtrlCreateGroup("Push Messages", $x - 10, $y + 35, 430, 45)
			$chkPushVillageReport = GUICtrlCreateCheckbox("Village Report", $x + 25, $y + 50, -1, -1)
			   GUICtrlSetState(-1, $GUI_DISABLE)
			   GUICtrlSetTip(-1, "Will send push message for village report")
			$chkPushMatchFound = GUICtrlCreateCheckbox("Match Found", $x + 145, $y + 50, -1, -1)
			   GUICtrlSetState(-1, $GUI_DISABLE)
			   GUICtrlSetTip(-1, "Will send push message when match found")
			$chkPushLastAttack = GUICtrlCreateCheckbox("Last Attack", $x + 265, $y + 50, -1, -1)
			   GUICtrlSetState(-1, $GUI_DISABLE)
			   GUICtrlSetTip(-1, "Will send push message of the stats of last attack")
	GUICtrlCreateGroup("", -99, -99, 1, 1)
GUICtrlCreateTabItem("")
;~ -------------------------------------------------------------
; Upgrades Tab
